...
<head>
    ...
    <link rel="stylesheet" href="src_used/account/account.css">
...
<body>
    ...
    <div class="body">
        <div class="Account_container">
            <div class="Account_inner_area">
                <div class="Account_profile_container">
                    <?php
                    
                    if ($userInfo) {
                        ?>
                        <div class="AccountProfile_name">
                            <h2 class="AccountProfile_name_text"><?php echo $userInfo['username']; ?></h2>
                        </div>
                        <div class="AccountProfile_email">
                            <p class="AccountProfile_email_text">
                                <?php echo $userInfo['email']; ?>
                            </p>
                        </div>
                    <?php } else { ?>
                        <div class="AccountProfile_name">
                            <h2 class="AccountProfile_name_text">User not found</h2>
                        </div>
                    <?php } ?>
                    <a class="AccountProfile_signout_button" href="logout.php">Log out</a>
                </div>
            </div>
        </div>
        <div class="Services_container">
            <p> More services are in development </p>
        </div>
